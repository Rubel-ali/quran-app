...
export default function SurahSidebar({
  ...
  const filtered = surahs.filter((s) => {
    ...
    return (
      s.englishName?.toLowerCase().includes(searchText) ||
      ...
      >
        ...
        <div className="p-4 border-b border-[#21262d]">
          ...
          <input
            ...
            className="w-full bg-[#161b22] border border-[#30363d] rounded-lg px-3 py-2 text-sm text-[#e6edf3] placeholder-[#6e7681] outline-none focus:border-[#3d8b3d]"
          />
        </div>
        ...
        <div className="flex-1 overflow-y-auto">
          {filtered.map((surah) => (
            <Link
              ...
              className={clsx(
                "flex items-center gap-3 px-4 py-3 hover:bg-[#161b22] transition-colors border-b border-[#161b22]",
